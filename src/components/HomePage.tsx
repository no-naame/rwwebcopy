  ...
  return (
    <>
      <div className="relative max-w-[100%] max-md:hidden block ">
        <div className=" px-3 relative mt-[140px] mb-[150px] 2xl:ml-[200px] 2xl:mr-[200px] flex justify-start items-center max-md:justify-center">
          <div className=" shopping z-10 ml-[80px] max-xl:scale-[0.9] ">
            <div className="text-5xl font-bold text-start text-[#272727]">
              Ab pay karna
            </div>
          ...
          <div className=" absolute max-w-[70%] mt-[180px] max-sm:hidden max-lg:mt-[50px] 2xl:scale-75 2xl:left-[625px] left-[425px] overflow-hidden">
            <Image src={homepage} alt="mainPic" />
          </div>
        </div>
      </div>
      <div className="homepage relative max-md:block hidden mt-[90px] mb-7">
        <div className="flex justify-center items-center flex-col relative mx-6">
          <div className=" pb-6 max-md:pb-2 flex flex-col ">
            <div className="max-2sm:text-[36px] text-[44px] text-center font-bold">
              Ab pay karna
            </div>
            <div className=" ml-10">
          ...
          <div className=" text-center text-[20px]">
            Unlock rewards and cashback on every transaction.
            <br />
            Only on RewardWise!
          </div>
      ...
      <div className="bg-[#FBE74E] mb-[30px] px-4 w-[100%] overflow-hidden block max-2sm:hidden">
        <div className="flex justify-center items-end max-lg:items-center max-lg:flex-col max-md:gap-10 gap-[56px]">
          <div className="max-w-[350px] ml-[90px] max-lg:ml-0  scale-125">
            <Image src={yellowImage} alt="Happy Shopper" />
          </div>
          <div className=" mr-[100px] mb-7 max-xl:mb-0 max-lg:mr-0">
            <div className="flex items-start ">
              <div className="text-5xl font-passionOne mr-1 max-md:mb-4">
                &#8220;
              </div>
              <div className="text-3xl font-lato max-lg:text-3xl max-lg:text-center">
                I deserve the bonuses that come with my spending. Why not take
                advantage of all the extras available to me?
      ...
      <div className="bg-[#FBE74E] mb-[30px] w-[100%] overflow-hidden hidden max-2sm:block">
        <div className="flex ">
          ...
          <div className=" mt-[32px] mr-[15px]">
            <div className="flex items-start ">
              <div className="text-xl font-passionOne relative bottom-2">
                &#8220;
              </div>
              <div className="text-[12px] font-lato relative">
                ...
                <span className="relative">
                  <span className=" font-passionOne text-xl absolute bottom-0 -top-2 left-1">
                    &#8221;
                  </span>
                </span>
              </div>
      ...
      <Slider />
      <h3 className="text-xl mt-10 ml-16 font-light text-black max-md:max-w-full">
        Join your favourite loyalty program
      </h3>
      <h3 className=" text-2xl ml-16 font-medium text-black max-md:max-w-full">
        In just 4 steps
      </h3>
      <Steps stepList={list} />
      ...
      <div className="p-[20px]">
        <div className=" max-2sm:text-[22px] max-2sm:font-medium text-5xl p-[20px] mx-[100px] max-2sm:mx-0 max-2sm:p-0 max-md:text-4xl max-md:mx-6 text-center font-semibold">
          Join the <span className=" text-[#C5393A]">loyalty programs</span>{" "}
          that rewards you on{" "}
          <span className="text-[#C5393A]">every transaction</span>
        </div>
      </div>
      <div className="relative overflow-hidden">
        <div className="relative flex flex-col ">
          <div className="relative">
            <Image src={newImage} alt="image" className="z-[-1]" />
          </div>
