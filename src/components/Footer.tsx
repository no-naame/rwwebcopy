...
const Footer = () => {
    return (
        <>
            ...
            <footer
                className='footer bg-[#101010] text-[#FCFCFC] p-[40px] md:px-8 lg:px-20 border border-t-2 border-t-[#DD2020] border-l-[black] border-r-[black] border-b-[black] block max-2sm:hidden'>
