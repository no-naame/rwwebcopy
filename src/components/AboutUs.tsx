        ...
        <>
            <div className="py-10">
                <div className="flex justify-evenly px-12 max-xl:flex-col-reverse max-xl:items-center">
                    <div className="mt-16">
                        <div className="text-[76px] max-md:text-5xl max-sm:text-3xl max-sm:gap-4 text-black/80 font-bold">
                    ...
                    <div className="RewardWise shadow py-14 px-12 rounded-[35px]">
                        <div className="flex flex-col gap-8">
                            ...
                            <div className="flex flex-col justify-center items-center">
                                <div className="text-[#C5393A] self-start mb-2 text-2xl">
                                    What is Rewardwise?
                                </div>
                    ...
                    <div className="Misson py-14 px-12 shadow rounded-[30px]">
                        <div className="flex flex-col gap-[36px]">
                            ...
                            <div className="flex flex-col justify-center items-center">
                                ...
                                <div className=" text-left text-xl">
                                    <span className="font-semibold mt-2">Our Mission</span> is to
                                    facilitate
                                    <br />
