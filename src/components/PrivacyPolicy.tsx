            ...
            <div>
                <div className="mx-[250px] max-md:mx-14 mt-10 mb-[40px]">
                    ...
                    <div className="mx-[20px] text-[20px]">
                        ...
                        <br></br>
                        <h2 className="font-[bold] text-[44px]">Interpretation and Definitions Interpretation</h2>
                        <br></br>
                        ...
                        <h1 className="font-[bold] text-[44px]">Definitions</h1>
                        <br></br>
                        ...
                        <ul className="list-disc pl-10">
                            ...
                            <li>Application refers to Rewardwise, the software program provided by the Company.</li>
                            <li>Company (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Ensemble Control Incorporation, 3301 Mansion Way Columbus, Ohio United States.</li>
                        ...
                        <br></br>
                        <p className="font-[bold] text-[44px]">Collecting and Using Your Personal Data Types of Data Collected</p>
                    </div>
                    <br></br>
                    <br></br>
                    <div className="mx-[20px] text-[20px]">
                        <h1 className="font-[bold] text-[27px]">Personal Data</h1>
                        ...
                        <br></br>
                        <h1 className="font-[bold] text-[27px]">Usage Data</h1>
                        ...
                        <br></br>
                        <h1 className="font-[bold] text-[27px]">Information Collected while Using the Application</h1>
                        <br></br>
                        ...
                        <br></br>
                        <h1 className="font-[bold] text-[40px]">Retention of Your Personal Data</h1>
                        <br></br>
                        ...
                        <br></br>
                        <h1 className="font-[bold] text-[40px]">Transfer of Your Personal Data</h1>
                        <br></br>
                        ...
                        <br></br>
                        <h1 className="font-[bold] text-[40px]">Delete Your Personal Data</h1>
                        <br></br>
                        ...
                        <br></br>
                        <h1 className="font-[bold] text-[40px]">Disclosure of Your Personal Data</h1>
                        <h1 className="font-[bold] text-[27px]">Business Transactions</h1>
                        <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
                        <h1 className="font-[bold] text-[27px]">Law enforcement</h1>
                        <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
                        <h1 className="font-[bold] text-[27px]">Other legal requirements</h1>
                        ...
                        <h1 className="font-[bold] text-[40px]">Security of Your Personal Data</h1>
                        <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
                        <h1 className="font-[bold] text-[40px]">Children's Privacy</h1>
                        ...
                        <h1 className="font-[bold] text-[40px]">Links to Other Websites</h1>
                        <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
                        <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
                        <h1 className="font-[bold] text-[40px]">Changes to this Privacy Policy</h1>
