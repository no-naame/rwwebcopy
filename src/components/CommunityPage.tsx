            ...
            <div className="bg-[#FCFCFC] p-8 mt-8 font-inter">
                <div className="text-center">
                    <div className="relative p-2">
                        <h1 className="text-6xl max-sm:text-4xl xl:text-7xl font-bold text-[#0A0A0A]">
                            Say hello to the
                        </h1>
                        <div className="relative flex justify-center items-center flex-wrap">
                            <div className="relative text-center mt-2 max-sm:w-[300px]">
                                <Image
                                    className="absolute top-0 ml-2 max-sm:p-2"
                                    src={overlay}
                                    alt="Background"
                                />
                                <h1 className="relative max-sm:text-4xl text-6xl xl:text-7xl my-4 mt-2 font-bold text-[#0A0A0A] px-10">
                                    Rewardwise
                                </h1>
                            </div>
                            <div>
                    ...
                    <div>
                        <p className="mt-2 text-2xl leading-6 max-sm:text-xl max-sm:font-medium font-bold text-[#1F1F1F]">
