        ...
        <div>
            <div className="max-w-7xl mx-auto p-6">
                <div className="text-center mb-12">
                    <h2 className="text-6xl font-medium mb-4 text-red-600 mt-36">Pricing Plans</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
                    <Card className="bg-white border-black rounded-lg shadow-md p-6 hover:shadow-lg mt-20">
                        <CardHeader className="mb-4">
                            <CardTitle className="text-4xl font-medium mb-3 text-center ">Starter</CardTitle>
                        ...
                        <CardContent className="mb-6 border-[#FBCC28] text-center">
                            <p className="text-3xl font-bold mb-4">₹ 12,000 <span className="text-lg font-medium">/Year</span></p>
                    ...
                    <div className="relative mt-5">
                        <div className="bg-[#3947C4] h-20 rounded-t-2xl flex items-center justify-center">
                        ...
                        <Card
                            ...
                            <CardHeader className="mb-4">
                                <div>
                                    <CardTitle className="text-4xl font-medium mb-3 text-center">Growth</CardTitle>
                                    <CardDescription className="text-lg text-black text-center">
                            ...
                            <CardContent className="mb-6 border-[#FBCC28]">
                                <p className="text-3xl font-bold mb-4 text-center">₹ 48,000 <span
                                    className="text-lg font-medium">/Year</span></p>
                    ...
                    <Card className="rounded-lg shadow-md p-6 hover:shadow-lg mt-20 border-black">
                        <CardHeader className="mb-4">
                            <CardTitle className="text-4xl font-medium mb-3 text-center">Enterprise</CardTitle>
                            <CardDescription className="text-lg text-black text-center">
